...
void main()
{
	...
	color = vec4(textColor, 1.0) * sampled;                          // vary the color by the alpha, also makes the background transparent where there is no pixel of the glyph and vice versa
}